...
<aside class="sidebar" id="mainSidebar">
    ...
    <nav class="nav">
        ...
        <a href="electricity-list.php" class="nav-item <?php echo in_array($current_page, ['electricity-list.php', 'update-electricity.php', 'manage-recharges.php']) ? 'active' : ''; ?>">
        ...
        <a href="master-ledger.php" class="nav-item <?php echo in_array($current_page, ['master-ledger.php', 'transactions-log.php', 'manage-payments.php']) ? 'active' : ''; ?>">
