...
<main class="main">
    ...
    <div class="animate-up">
        <div style="max-width: 1000px; margin: 0 auto; width: 100%;">
            <div class="panel" style="padding: 40px 48px; border-radius: 20px; box-shadow: 0 12px 40px rgba(0,0,0,0.06); border: 1px solid rgba(0,0,0,0.05); background: var(--white); border-top: 5px solid var(--primary-purple);">
                <?php if ($success): ?>
