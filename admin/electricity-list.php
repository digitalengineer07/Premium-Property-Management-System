        ...
        <div class="panel animate-up" style="max-width: 450px; width: 100%; padding: 32px; background: var(--white);">
            ...
            <form action="mark-paid.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="payment_mode" id="paymentMode" required style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid var(--border); background: var(--bg-main); color: var(--text-dark);">
                ...
                <div style="border-top: 1px dashed var(--border); padding-top: 20px; margin-top: 20px;">
                    <div class="form-group" style="margin-bottom: 15px;">
                        ...
                        <input type="number" step="0.01" name="paid_amount" id="paidAmountInput" placeholder="Enter amount" required style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid var(--border); background: var(--bg-main); color: var(--text-dark);">
                        <small style="color: var(--text-gray); font-size: 11px;">You can enter a partial payment amount.</small>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                        <div class="form-group">
                            <label>Date</label>
                            <input type="date" name="payment_date" id="paymentDateInput" required style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid var(--border); background: var(--bg-main); color: var(--text-dark);">
                        </div>
                        <div class="form-group">
                            <label>Time</label>
                            <input type="time" name="payment_time" id="paymentTimeInput" required style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid var(--border); background: var(--bg-main); color: var(--text-dark);">
                        </div>
                    </div>
                </div>
