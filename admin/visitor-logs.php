...
<body>
    ...
    <main class="main">
                        ...
                        <div class="pt-left">
                            <div class="log-user">
                                ...
                                if ($isAdmin)
                                    ...
                                    echo htmlspecialchars($row['name'] ?? 'Unknown User') . " <span style='color: #94A3B8; font-weight: 500; font-size: 14px;'>— Room " . ($row['room_no'] ?? 'N/A') . "</span>";
                                ?>
        ...
        <div id="pagination"
            ...
            <div
                style="width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; border-radius: 14px; background: var(--primary-purple); color: #fff; font-weight: 700; font-size: 16px; box-shadow: 0 8px 20px rgba(98, 75, 255, 0.3);">
                <?php echo $page; ?>
            </div>
