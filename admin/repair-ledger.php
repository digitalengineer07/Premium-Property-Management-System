...
<head>
    ...
    <style>
        ...
        .container { max-width: 800px; margin: 0 auto; background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.03); }
        ...
        .card { border: 1px solid #E2E8F0; border-radius: 12px; padding: 24px; margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; }
        .card-info h3 { margin: 0 0 8px 0; color: #1E293B; }
        .card-info p { margin: 0; color: #64748B; font-size: 14px; line-height: 1.5; }
...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        ...
        <a href="index.php" style="color: #64748B; text-decoration: none; font-weight: 500;">&larr; Back to Dashboard</a>
    </div>

    <p style="color: #64748B; margin-bottom: 30px;">Use these diagnostic tools to clean up any database anomalies caused by old bugs before the system was patched.</p>
