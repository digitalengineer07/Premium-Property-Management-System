...
target_str = "THEN (rent_amount + maintenance + dues)"
replacement_str = "THEN (rent_amount + maintenance)"
...
if os.path.exists(filepath):
    ...
    target_alloc = "amount as elec_part, (rent_amount + maintenance + dues) as rent_part"
    replacement_alloc = "amount as elec_part, (rent_amount + maintenance) as rent_part"
