    ...
    <div class="invoice-container">
        <div class="invoice-content" id="invoiceArea">
            ...
            <div class="footer-banner">
                ...
                <div class="signatory">
                    <img src="../assets/img/signature.png" onerror="this.style.display='none'; this.insertAdjacentHTML('afterend', '<h3 style=\'font-family:cursive;color:var(--text-dark);margin:0;\'>Authorized</h3>');" alt="Signature" class="signatory-img">
                    <p>Authorized Signatory</p>
                    <p class="sig-name"><?php echo HOUSE_NAME; ?> Residence</p>
                </div>
