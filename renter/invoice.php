        ...
        <div class="invoice-content" id="invoiceArea">
            ...
            <div class="header-section">
                <div class="brand-section">
                    <img src="../assets/img/logo.png?v=<?php echo time(); ?>" onerror="this.src='../assets/img/favicon.png'; this.onerror=null;" alt="Logo" style="height: 64px; object-fit: contain; transform: scale(1.6);">
