...
<div class="app-container">
    ...
    <!-- Main Content -->
        ...
        <!-- 1. EXCLUSIVE MOBILE VIEW CODE (Isolated in views/mobile/my-bills_mobile.php) -->
        <div class="mobile-view-wrapper">
            <?php include __DIR__ . '/views/mobile/my-bills_mobile.php'; ?>
        </div>

        <!-- 2. EXCLUSIVE DESKTOP VIEW CODE (Isolated in views/desktop/my-bills_desktop.php) -->
        <div class="desktop-view-wrapper">
            <?php include __DIR__ . '/views/desktop/my-bills_desktop.php'; ?>
        </div>
</main>
