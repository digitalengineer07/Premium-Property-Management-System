...
if ($is_mobile) {
    require 'views/mobile/payment-approvals_mobile.php';
} else {
    require 'views/desktop/payment-approvals_desktop.php';
}
?>
"""

with open(r'c:\xampp\htdocs\renter-system\renter\payment-approvals.php', 'w', encoding='utf-8') as f:
