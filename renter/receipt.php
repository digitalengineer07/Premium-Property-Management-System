    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media print {
            ...
            .bottom-thank h2 { font-size: 18px !important; margin-bottom: 4px; }
            .bottom-thank h3 { font-size: 11px !important; }
                ...
                <div class="logo-text">
                    <div style="display: flex; align-items: center; gap: 16px;">
                        ...
                        <div style="width: 70px; height: 60px;">
                            <img src="../assets/img/logo.png?v=<?php echo time(); ?>" alt="Logo" style="width: 100%; height: 100%; object-fit: contain; transform: scale(1.6);">
                        </div>
                        <div>
