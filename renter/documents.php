...
<head>
    ...
    <style>
        ...
        .main-content {
            width: calc(100% - 230px); margin-left: 230px; padding: 32px 40px; box-sizing: border-box; overflow-y: auto; min-height: 100vh;
        }
        ...
        .kpi-card { background: var(--white); border: 1px solid var(--border); border-radius: 16px; padding: 32px 20px; box-shadow: var(--card-shadow); display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; gap: 16px; transition: 0.2s; }
        .kpi-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.06); }
        .kpi-icon { width: 64px; height: 64px; border-radius: 16px; display: flex; align-items: center; justify-content: center; font-size: 30px; flex-shrink: 0; margin-bottom: 8px; }
        .kpi-info h4 { margin: 0 0 8px 0; font-size: 14px; color: var(--text-gray); font-weight: 600; }
        .kpi-info h2 { margin: 0 0 8px 0; font-size: 32px; color: var(--text-dark); font-weight: 800; line-height: 1; }
        .kpi-info p { margin: 0; font-size: 12px; font-weight: 600; color: var(--text-gray); }
