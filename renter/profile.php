...
<head>
    ...
    function openProfileSection(section) {
        ...
        if (section === 'password') {
            ...
            if(passwordForm) {
                passwordForm.style.display = 'block'; /* Use block instead of flex */
                passwordForm.style.opacity = '1';
                passwordForm.style.visibility = 'visible';
                passwordForm.style.paddingBottom = '50px'; /* Normal padding */
            }
            ...
            <form method="POST" action="">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="rent_amount" value="<?php echo number_format($user['fixed_rent'] ?? 0); ?>" style="width: 100%; padding: 12px 16px; border-radius: 14px; border: 1px solid var(--border); background: #F8FAFC; font-size: 14px; box-sizing: border-box; cursor: not-allowed; color: var(--text-gray);" readonly>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="maintenance" value="<?php echo number_format($user['fixed_maintenance'] ?? 0); ?>" style="width: 100%; padding: 12px 16px; border-radius: 14px; border: 1px solid var(--border); background: #F8FAFC; font-size: 14px; box-sizing: border-box; cursor: not-allowed; color: var(--text-gray);" readonly>
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <input type="text" name="advance_payment" value="<?php echo number_format($user['advance_payment'] ?? 0); ?>" style="width: 100%; padding: 12px 16px; border-radius: 14px; border: 1px solid var(--border); background: #F8FAFC; font-size: 14px; box-sizing: border-box; cursor: not-allowed; color: var(--text-gray);" readonly>
                    </div>
                </div>
