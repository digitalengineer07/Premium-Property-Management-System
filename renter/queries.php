...
<head>
    ...
    <style>
        ...
        .kpi-card {
            ...
            border-radius: 16px; padding: 20px; box-shadow: var(--card-shadow);
        ...
        .kpi-info { width: 100%; display: flex; flex-direction: column; }
        .kpi-info h4 { margin: 0 0 8px 0; font-size: 13px; color: var(--text-gray); font-weight: 600; }
        .kpi-info h2 { margin: 0 0 12px 0; font-size: 26px; color: var(--text-dark); font-weight: 800; line-height: 1; }
        .kpi-badge {
