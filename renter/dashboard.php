...
/* Fetch profile */
$stmt = mysqli_prepare($conn, "SELECT username, name, phone, whatsapp, room_no, profile_pic, must_change_password, pending_adjustment, advance_payment, security_deposit, advance_updated_at, fixed_rent, fixed_maintenance, rent_maint_updated_at, block, floor, parking, joining_date FROM users WHERE id = ?");
...
<head>
    ...
    <style>
        ...
        .btn-fw { border: 1px solid rgba(98, 75, 255, 0.2); background: transparent; color: var(--primary-purple); padding: 10px 14px; border-radius: 12px; font-weight: 700; font-size: 13px; cursor: pointer; transition: 0.2s; box-shadow: 0 2px 8px rgba(98,75,255,0.03); white-space: nowrap; display: inline-flex; align-items: center; justify-content: center; gap: 6px; }
...
<div class="app-container">
    ...
    <main class="main-content">
        <!-- 1. EXCLUSIVE MOBILE VIEW CODE (Isolated in views/mobile/dashboard_mobile.php) -->
        <div class="mobile-view-wrapper">
            <?php include __DIR__ . '/views/mobile/dashboard_mobile.php'; ?>
        </div>

        <!-- 2. EXCLUSIVE DESKTOP VIEW CODE (Isolated in views/desktop/dashboard_desktop.php) -->
        <div class="desktop-view-wrapper">
            <?php include __DIR__ . '/views/desktop/dashboard_desktop.php'; ?>
        </div>
</main>
</div>
    ...
    <style>
        ...
        .introjs-tooltiptext { color: inherit; font-size: 13px; line-height: 1.6; opacity: 0.9; }
